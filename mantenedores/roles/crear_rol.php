...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $descripcion_rol = $_POST['descripcion_rol']; // Nueva descripción
    $permisos = isset($_POST['permisos']) ? $_POST['permisos'] : [];

    // Insertar el nuevo rol en la base de datos
    $query_rol = "INSERT INTO rol (nombre_rol, descripcion_rol) VALUES (?, ?)"; // Ajustar para incluir la descripción
    ...
    <div class="container mt-5">
        ...
        <form action="crear_rol.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descripcion_rol" name="descripcion_rol" rows="3" required></textarea>
            </div>

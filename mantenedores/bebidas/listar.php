                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($row['imagen'])): ?>
                                <img src="../../uploads/bebidas/<?php echo htmlspecialchars($row['imagen']); ?>" alt="Imagen Bebida" style="width: 50px; height: 50px; object-fit: cover;">
                            <?php else: ?>
                                No disponible
                            <?php endif; ?>
                        </td>
                        <td>
                            <a href="editar.php?id=<?php echo $row['id_bebida']; ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
                            <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#eliminarModal" data-id="<?php echo $row['id_bebida']; ?>"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
                <tr>
                    <td colspan="6" class="text-center">No se encontraron bebidas.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>

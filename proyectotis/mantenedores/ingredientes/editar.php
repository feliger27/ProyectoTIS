...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        echo "<div class='alert alert-success' role='alert'>Ingrediente editado exitosamente.</div>";
    } else {
        echo "<div class='alert alert-danger' role='alert'>Error al editar el ingrediente: " . $conexion->error . "</div>";
    }
}
?>
